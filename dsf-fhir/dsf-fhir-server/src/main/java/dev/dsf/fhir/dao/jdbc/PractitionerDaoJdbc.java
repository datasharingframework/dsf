...
public class PractitionerDaoJdbc extends AbstractResourceDaoJdbc<Practitioner> implements PractitionerDao
{
	...
	{
		super(dataSource, permanentDeleteDataSource, fhirContext, objectMapper, Practitioner.class, "practitioners",
				"practitioner", "practitioner_id", PractitionerIdentityFilter::new,
