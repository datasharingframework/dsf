...
public class ProvenanceDaoJdbc extends AbstractResourceDaoJdbc<Provenance> implements ProvenanceDao
{
	...
	{
		super(dataSource, permanentDeleteDataSource, fhirContext, objectMapper, Provenance.class, "provenances",
				"provenance", "provenance_id", ProvenanceIdentityFilter::new, List.of(), List.of());
	}
