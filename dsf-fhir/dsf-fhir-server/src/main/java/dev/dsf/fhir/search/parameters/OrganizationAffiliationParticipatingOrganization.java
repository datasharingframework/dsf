...
@IncludeParameterDefinition(resourceType = OrganizationAffiliation.class, parameterName = OrganizationAffiliationParticipatingOrganization.PARAMETER_NAME, targetResourceTypes = Organization.class)
@SearchParameterDefinition(name = OrganizationAffiliationParticipatingOrganization.PARAMETER_NAME, definition = "http://hl7.org/fhir/SearchParameter/OrganizationAffiliation-participating-organization", type = SearchParamType.REFERENCE, documentation = "The organization that provides services to the primary organization")
		...
		extends AbstractReferenceParameter<OrganizationAffiliation>
{
			...
			throws SQLException
	{
		...
		Reference reference = resource.getParticipatingOrganization();
