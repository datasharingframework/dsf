...
public class DocumentReferenceDaoJdbc extends AbstractResourceDaoJdbc<DocumentReference> implements DocumentReferenceDao
{
	...
	{
		super(dataSource, permanentDeleteDataSource, fhirContext, objectMapper, DocumentReference.class,
				"document_references", "document_reference", "document_reference_id",
				DocumentReferenceIdentityFilter::new, List.of(factory(DocumentReferenceIdentifier.PARAMETER_NAME,
						DocumentReferenceIdentifier::new, DocumentReferenceIdentifier.getNameModifiers())),
				List.of());
	}
