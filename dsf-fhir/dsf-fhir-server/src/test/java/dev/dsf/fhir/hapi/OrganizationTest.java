...
public class OrganizationTest
{
	...
	public void testOrganizationJson() throws Exception
	{
		...
		thumbprint1.setUrl("http://dsf.dev/fhir/StructureDefinition/extension-certificate-thumbprint");
		...
		thumbprint2.setUrl("http://dsf.dev/fhir/StructureDefinition/extension-certificate-thumbprint");
