...
public class ResearchStudyTest
{
	...
	public void testReferenceExtension() throws Exception
	{
		...
		r.addExtension().setUrl("http://dsf.dev/fhir/StructureDefinition/extension-participating-medic")
		...
		assertTrue(r.getExtensionByUrl("http://dsf.dev/fhir/StructureDefinition/extension-participating-medic")
