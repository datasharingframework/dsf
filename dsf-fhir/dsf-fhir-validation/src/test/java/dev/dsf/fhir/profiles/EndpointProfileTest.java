...
public class EndpointProfileTest
{
	...
	public static final ValidationSupportRule validationRule = new ValidationSupportRule(
			Arrays.asList("dsf-endpoint-0.5.0.xml"),
			Arrays.asList("dsf-read-access-tag-0.5.0.xml", "urn_ietf_bcp_13.xml"),
			Arrays.asList("dsf-read-access-tag-0.5.0.xml", "valueset-mimetypes.xml"));
