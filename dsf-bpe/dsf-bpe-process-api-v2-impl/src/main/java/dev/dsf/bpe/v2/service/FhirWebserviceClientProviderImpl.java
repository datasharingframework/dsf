...
import dev.dsf.bpe.v2.client.FhirWebserviceClientJersey;
...
public class FhirWebserviceClientProviderImpl implements FhirWebserviceClientProvider, InitializingBean
{
	...
	public FhirWebserviceClientProviderImpl(FhirContext fhirContext, String localWebserviceBaseUrl,
			...
			int remoteWebserviceReadTimeout, int remoteWebserviceConnectTimeout, boolean remoteWebserviceLogRequests,
			ProxyConfig proxyConfig, BuildInfoProvider buildInfoProvider, ReferenceCleaner referenceCleaner)
	{
