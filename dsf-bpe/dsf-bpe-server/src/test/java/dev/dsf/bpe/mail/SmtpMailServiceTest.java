...
public class SmtpMailServiceTest
{
	...
	{
		new SmtpMailService("from@localhost", List.of("to@localhost"), "localhost", 1025).send("test subject",
				"test message");
	}
	...
	{
		new SmtpMailService("from@localhost", List.of("to1@localhost", "to2@localhost"),
				List.of("cc1@localhost", "cc2@localhost"), List.of("replyTo1@localhost", "replyTo2@localhost"), false,
				"localhost", 1025, null, null, null, null, null, null, null, false, 0,
	...
	public void testSendSigned() throws Exception
	{
		...
		new SmtpMailService("from@localhost", List.of("to@localhost"), null, null, false, "localhost", 1025, null, null,
				null, null, null, signStore, signStorePassword, false, 0, SmtpMailService.DEFAULT_DEBUG_LOG_LOCATION)
