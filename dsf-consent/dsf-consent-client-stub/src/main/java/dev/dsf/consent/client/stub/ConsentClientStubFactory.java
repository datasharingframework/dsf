...
public class ConsentClientStubFactory implements ConsentClientFactory
{
	...
	{
		String ehrIdColumnName = propertyResolver.apply("dev.dsf.bpe.openehr.subject.external.id.name",
				EHRID_COLUMN_DEFAULT_NAME);
		String ehrIdColumnPath = propertyResolver.apply("dev.dsf.bpe.openehr.subject.external.id.path",
